...
async function main() {
  ...
  const inboxPublicTx = await inbox.connect(deployer).makeSolvingPublic()
  await inboxPublicTx.wait()
  console.log('Inbox made public in transaction:', inboxPublicTx.hash)
