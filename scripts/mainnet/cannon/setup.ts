...
export namespace s {
  ...
  export const layer2SourceProverContract = new Contract(
    config.base.proverContractAddress,
    Prover__factory.abi,
  ...
  export const Layer2DestinationMessagePasserContract = new Contract(
    config.optimism.l2l1MessageParserAddress,
  ...
  // Intent Parameters
  export const intentCreator = config.intents.optimism.creator
  export const intentSourceAddress = config.base.intentSourceAddress
  export const intentRewardAmounts = config.intents.optimism.rewardAmounts
  export const intentRewardTokens = config.intents.optimism.rewardTokens
  export const intentDestinationChainId: BigNumberish =
    config.intents.optimism.destinationChainId
  export const intentTargetTokens = config.intents.optimism.targetTokens
  export const intentTargetAmounts = config.intents.optimism.targetAmounts
  export const intentRecipient = config.intents.optimism.recipient
  export const intentDuration = config.intents.optimism.duration
}
