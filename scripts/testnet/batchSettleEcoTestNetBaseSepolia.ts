...
export async function getBatchSettled() {
  ...
  console.log('endBatchBlockDataL2: ', endBatchBlockDataL2)
...
async function proveSepoliaSettlementLayerStateOnBaseSepolia() {
  ...
  const provedSettlementState = false
  let errorCount = 0
...
async function main() {
  ...
  try {
    ...
    console.log('settlementBlockNumber: ', endBatchBlockDataL2.number)
